...
lsp_installer.setup {
  ...
  ensure_installed = { "bashls", "cssls", "eslint", "graphql", "html", "jsonls", "sumneko_lua", "tailwindcss", "tsserver", "vetur", "vuels", "solargraph" },
...
lspconfig.solargraph.setup {
  ...
  handlers = handlers,
  on_attach = on_attach,
  settings = require('lsp.servers.solargraph').settings
}
